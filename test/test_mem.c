...
void cleanup_mem(void **allocated_memory_list, unsigned int *allocated_memory_count){
...
bool test_malloc(void **allocated_memory_list, unsigned int *allocated_memory_count){
	printf("Test malloc\n");
...
bool test_calloc(void **allocated_memory_list, unsigned int *allocated_memory_count){
	printf("Test calloc\n");
...
bool test_realloc(void **allocated_memory_list, unsigned int *allocated_memory_count){
...
bool test_free(void **allocated_memory_list, unsigned int *allocated_memory_count){
	if(*allocated_memory_count == 0)
		return 0;
	printf("Test free\n");
