...
void __set_filename_from_env(char *file, const char *default_postfix,
                             const char *env_var) {
...
bool log_memory_usage() { return __is_set(ENV_MEMORY_USAGE); }

bool log_file_usage() { return __is_set(ENV_FILE_USAGE); }

bool log_syscall() { return __is_set(ENV_LOG_SYSCALL); }

bool log_overhead_calc() { return __is_set(ENV_OVERHEAD_CALC); }
